        ...
        <div className="home-navbar">
          <div className="home-left-side">
            <div className="home-links-container">
              ...
              <Link to="/sponsors" className="home-link01 Anchor">
                <span>Spons</span>
                <span>ors</span>
              </Link>
              <Link to="/donate" className="home-link02 Anchor">
                Donate
              </Link>
              <Link to="/achievements" className="home-link03">
      ...
      <div className="home-hero3">
        <div className="home-container5">
          <div className="home-container6">
            ...
            <Link to="/sponsors" className="home-navlink08 button">
              Become a sponsor
            </Link>
          </div>
      ...
      <div className="home-footer-container">
        <div className="home-footer">
          <div className="home-social-links">
            ...
            <a
              href="https://www.instagram.com/1124uberbots/?igshid=YmMyMTA2M2Y%3D"
              target="_blank"
          ...
          <div className="home-copyright-container">
            ...
            <span className="home-link09 Anchor">Copyright, 2023</span>
          </div>
        </div>
      </div>
    </div>
